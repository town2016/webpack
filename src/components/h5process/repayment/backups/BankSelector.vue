  ...
  <div class="bank-selector" v-show='isShow'>
    <transition name='slide' v-on:after-leave="afterLeave">
      <div class="inner" v-if='isSlide'>
        ...
        <div class="body">
          <bankCell v-for='(item,index) in bankArr' :bankCellInfo='item'
                    :selected='selIndex===index' :key='index||item.id' type='selectabled'
                    @selHanlder='tickSwitch(index)' />
...
<script>
import bankCell from '@/components/h5process/repayment/BankCell.vue';
